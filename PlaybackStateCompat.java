...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject) {
    ...
    List list = null;
    PlaybackState playbackState1 = playbackState2;
    if (paramObject != null) {
      playbackState1 = playbackState2;
      if (Build.VERSION.SDK_INT >= 21) {
        Bundle bundle;
        playbackState2 = (PlaybackState)paramObject;
        List list1 = playbackState2.getCustomActions();
        if (list1 != null) {
          paramObject = new ArrayList(list1.size());
          Iterator iterator = list1.iterator();
          while (iterator.hasNext())
            paramObject.add(CustomAction.fromCustomAction(iterator.next())); 
        } else {
          paramObject = null;
        } 
        list1 = list;
        if (Build.VERSION.SDK_INT >= 22) {
          bundle = playbackState2.getExtras();
          MediaSessionCompat.ensureClassLoader(bundle);
        } 
        playbackStateCompat = new PlaybackStateCompat(playbackState2.getState(), playbackState2.getPosition(), playbackState2.getBufferedPosition(), playbackState2.getPlaybackSpeed(), playbackState2.getActions(), 0, playbackState2.getErrorMessage(), playbackState2.getLastPositionUpdateTime(), (List<CustomAction>)paramObject, playbackState2.getActiveQueueItemId(), bundle);
        playbackStateCompat.mStateFwk = playbackState2;
      } 
    } 
  ...
  public Object getPlaybackState() {
    if (this.mStateFwk == null && Build.VERSION.SDK_INT >= 21) {
      ...
      while (iterator.hasNext())
        builder.addCustomAction((PlaybackState.CustomAction)((CustomAction)iterator.next()).getCustomAction()); 
  ...
  public String toString() {
    StringBuilder stringBuilder = new StringBuilder(v416f9e89.xbd520268("772"));
    stringBuilder.append(v416f9e89.xbd520268("773"));
    stringBuilder.append(this.mState);
    stringBuilder.append(v416f9e89.xbd520268("774"));
    stringBuilder.append(this.mPosition);
    stringBuilder.append(v416f9e89.xbd520268("775"));
    stringBuilder.append(this.mBufferedPosition);
    stringBuilder.append(v416f9e89.xbd520268("776"));
    stringBuilder.append(this.mSpeed);
    stringBuilder.append(v416f9e89.xbd520268("777"));
    stringBuilder.append(this.mUpdateTime);
    stringBuilder.append(v416f9e89.xbd520268("778"));
    stringBuilder.append(this.mActions);
    stringBuilder.append(v416f9e89.xbd520268("779"));
    stringBuilder.append(this.mErrorCode);
    stringBuilder.append(v416f9e89.xbd520268("780"));
    stringBuilder.append(this.mErrorMessage);
    stringBuilder.append(v416f9e89.xbd520268("781"));
    stringBuilder.append(this.mCustomActions);
    stringBuilder.append(v416f9e89.xbd520268("782"));
    stringBuilder.append(this.mActiveItemId);
    stringBuilder.append(v416f9e89.xbd520268("783"));
  ...
  public static final class Builder {
    ...
    public Builder(PlaybackStateCompat param1PlaybackStateCompat) {
      ...
      if (param1PlaybackStateCompat.mCustomActions != null)
        arrayList.addAll(param1PlaybackStateCompat.mCustomActions); 
    ...
    public Builder addCustomAction(PlaybackStateCompat.CustomAction param1CustomAction) {
      ...
      throw new IllegalArgumentException(v416f9e89.xbd520268("761"));
    }
  ...
  public static final class CustomAction implements Parcelable {
    ...
    public static CustomAction fromCustomAction(Object param1Object) {
      ...
      Bundle bundle = param1Object.getExtras();
      MediaSessionCompat.ensureClassLoader(bundle);
      CustomAction customAction = new CustomAction(param1Object.getAction(), param1Object.getName(), param1Object.getIcon(), bundle);
      customAction.mCustomActionFwk = (PlaybackState.CustomAction)param1Object;
      return customAction;
    }
    ...
    public String toString() {
      ...
      stringBuilder.append(v416f9e89.xbd520268("769"));
      stringBuilder.append(this.mName);
      stringBuilder.append(v416f9e89.xbd520268("770"));
      stringBuilder.append(this.mIcon);
      stringBuilder.append(v416f9e89.xbd520268("771"));
      ...
      public Builder(String param2String, CharSequence param2CharSequence, int param2Int) {
        if (!TextUtils.isEmpty(param2String)) {
          if (!TextUtils.isEmpty(param2CharSequence)) {
            ...
            throw new IllegalArgumentException(v416f9e89.xbd520268("762"));
          } 
          throw new IllegalArgumentException(v416f9e89.xbd520268("763"));
        } 
        throw new IllegalArgumentException(v416f9e89.xbd520268("764"));
      }
...
/* Location:              C:\soft\dex2jar-2.0\8 Ball Pool-dex2jar.jar!\android\support\v4\media\session\PlaybackStateCompat.class
